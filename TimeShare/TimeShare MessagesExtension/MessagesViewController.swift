...
class MessagesViewController: MSMessagesAppViewController {
    ...
    // Helper method : it accepts a date, and returns a string containing that date formatted in a specific way, using the UTC timezone, so that everyone sees the same thing.
